...
export const ManagerEs = () => {
 ...
 if (user) {
  ...
  useEffect(() => {
    document.title = t('Manager Spanish');
  }, []);
...
<div style={{ backgroundColor: "#c4d3f6"}}>
  ...
  <div className="container">
    <p style={{position: "absolute", top: "70px", fontSize: "25px"}}>Форма редактирования сайта для Испанского языка</p>
    <div className={s.form}>
      <div className={s.ul}>
        <div className={s.li} >
          <NavLink to="/main-cards-edit-es">Tarjetas de la página de inicio</NavLink>
          <NavLink to="/main-cards-edit-es"><img width={"100px"} src={cards} alt='' /></NavLink>
        </div>
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
          <NavLink to="/footer-edit-es">Parte inferior del sitio</NavLink>
          <NavLink to="/footer-edit-es"><img width={"100px"} src={footer} alt='' /></NavLink>
        </div>
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
          <NavLink to="/main-video-edit-es">Vídeos en la página principal</NavLink>
          <NavLink to="/main-video-edit-es"><img width={"100px"} src={mainvideo} alt='' /></NavLink>
        </div>
        
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
          <NavLink to="/videobook-edit-es">Videolibro</NavLink>
          <NavLink to="/videobook-edit-es"><img width={"100px"} src={video} alt='' /></NavLink>
        </div>
        
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
          <NavLink to="/audiobook-edit-es">Audiolibro</NavLink>
          <NavLink to="/audiobook-edit-es"><img width={"100px"} src={audio} alt='' /></NavLink>
        </div>
