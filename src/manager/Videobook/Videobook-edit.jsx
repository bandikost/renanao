...
export const videobookEdit = () => {
  ...
  const [videobookRu, setvideobookRu] = useState(null);
    ...
    uploadTask.on(
      ...
      () => {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
          const newvideobookRu = { ...videobookRu };
          newvideobookRu[`videoUrl${index}`] = downloadURL;
          setvideobookRu(newvideobookRu);
  ...
  value={newValues[`episode${i}`] || videobookRu?.[`episode${i}`] || ""}
  onChange={(e) =>
    setNewValues({
      ...newValues,
...
/>
  ...
  <div className="video-container" >
    ...
    {videobookRu && videobookRu[`videoUrl${i}`] && (
      <div>
        <video style={{ width: "200px" }} src={videobookRu[`videoUrl${i}`]} controls alt="property" />
      </div>
    )}
