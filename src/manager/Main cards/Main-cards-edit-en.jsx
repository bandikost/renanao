...
export const MaincardsEditEn = () => {
  const [cardsEn, setcardsEn] = useState(null);
  ...
  useEffect(() => {
    document.title = t('Cards English Edit');
  }, []);
              ...
              <div key={i} className="table-cards">
                <label style={{ margin: "0px 50px" }}>
                  ...
                  <input
                    ...
                    type="text"
                    value={newValues[`dis${i}`] || cardsEn?.[`dis${i}`] || ""}
                    onChange={(e) =>
                      setNewValues({
                        ...newValues,
...
export default MaincardsEditEn;