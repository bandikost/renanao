...
export const AudiobookEdit = () => {
  ...
  const handleNumSeriesChangeAudio = (event) => {
  ...
  useEffect(() => {
    document.title = t('Audio Russian Edit');
  }, []);
    ...
    uploadTask.on(
      ...
      () => {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
          ...
          newaudiobook[`videoUrl${index}`] = downloadURL;
  ...
  value={newValues[`episode${i}`] || audiobook?.[`episode${i}`] || ""}
  onChange={(e) =>
    setNewValues({
      ...newValues,
...
/>
  ...
  <div className="video-container" >
    ...
    {audiobook && audiobook[`videoUrl${i}`] && (
      <div>
        <video style={{ width: "200px" }} src={audiobook[`videoUrl${i}`]} controls alt="property" />
      </div>
    )}
...
<div className="container">
  ...
  type="number"
  value={numSeries}
  onChange={handleNumSeriesChangeAudio}
/>
    </div>
